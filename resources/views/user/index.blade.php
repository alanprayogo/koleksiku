            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-xl-0 mb-4">
                        <h3 class="font-weight-bold">{{ Auth::user()->fullname }}</h3>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="sales-chart-legend" class="chartjs-legend mb-2 mt-4"></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table-borderless table">
                                <thead>
                                    <tr>
                                        <th class="border-bottom pb-2 ps-0">Places</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="pb-0 ps-0">Louisiana</td>
                                        <td class="pb-0">
                                            <p class="mb-0">
